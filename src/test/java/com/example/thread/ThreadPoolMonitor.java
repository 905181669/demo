...
public class ThreadPoolMonitor extends ThreadPoolExecutor {
    ...
    public static void main(String[] args) {
        ...
        ThreadPoolMonitor threadPoolMonitor = new ThreadPoolMonitor(5,
                10, 60, TimeUnit.SECONDS, new ArrayBlockingQueue<>(4), "monitor");
        ...
        for(int i = 0; i < 10; i++){
            ...
            threadPoolMonitor.execute(run);
        }

        /**
         * 可以开启一个线程池监控线程，对需要监控的线程池加入一个队列中，然后线程池监控线程每隔10秒获取信息上报到监控系统
         */
